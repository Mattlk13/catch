...
- (void)describeMismatchOf:(id)item to:(id<HCDescription>)mismatchDescription
{
    ...
    if (item)
        [mismatchDescription appendText:[NSString stringWithFormat:@"0x%0x ", (uint)item]];
    [mismatchDescription appendDescriptionOf:item];
}

- (void)describeTo:(id<HCDescription>)description
{
    [[description appendText:[NSString stringWithFormat:@"same instance as 0x%0x ", (uint)object]]
